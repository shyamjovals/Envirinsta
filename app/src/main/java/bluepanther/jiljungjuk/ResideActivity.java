...
import bluepanther.jiljungjuk.Contacts_Grid.Contacts;
...
import bluepanther.jiljungjuk.RegisterCompaint_Grid.MainActivity;
...
public class ResideActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ResideMenuItem itemRegisterComplaint;
    private ResideMenuItem itemNGO;
...
Boolean flagz;
    ...
    private void setUpMenu() {
        ...
        resideMenu.setBackground(R.drawable.grass);
        ...
        // create menu items;
        itemRegisterComplaint = new ResideMenuItem(this, R.drawable.ic_action_books, "Issues");
        itemNGO = new ResideMenuItem(this, R.drawable.ic_action_indi_sv, "NGO");
        itemContacts = new ResideMenuItem(this, R.drawable.ic_action_comp, "Contacts");
...
//        itemReports = new ResideMenuItem(this, R.drawable.ic_action_rec, "Contacts");
        ...
        itemRegisterComplaint.setOnClickListener(this);
        itemNGO.setOnClickListener(this);
...
//        itemReports.setOnClickListener(this);
        ...
        resideMenu.addMenuItem(itemRegisterComplaint, ResideMenu.DIRECTION_LEFT);
        resideMenu.addMenuItem(itemNGO, ResideMenu.DIRECTION_LEFT);
...
//        });
    ...
    public void onClick(View view) {
        ...
        if (view == itemRegisterComplaint) {
            ...
            Intent intent = new Intent(ResideActivity.this, Contacts.class);
